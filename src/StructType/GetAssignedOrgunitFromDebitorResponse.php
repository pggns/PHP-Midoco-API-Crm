...
class GetAssignedOrgunitFromDebitorResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitForArrayConstraintsFromSetMidocoOrgunit(array $values = []): string
    {
        ...
        foreach ($values as $getAssignedOrgunitFromDebitorResponseMidocoOrgunitItem) {
            ...
            if (!$getAssignedOrgunitFromDebitorResponseMidocoOrgunitItem instanceof \Pggns\MidocoApi\Crm\StructType\OrgunitDTO) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\OrgunitDTO[] $midocoOrgunit
     * @return \Pggns\MidocoApi\Crm\StructType\GetAssignedOrgunitFromDebitorResponse
     */
