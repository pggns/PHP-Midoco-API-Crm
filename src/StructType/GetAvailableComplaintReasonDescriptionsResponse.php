...
class GetAvailableComplaintReasonDescriptionsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoComplaintReasonDescriptionForArrayConstraintsFromSetMidocoComplaintReasonDescription(array $values = []): string
    {
        ...
        foreach ($values as $getAvailableComplaintReasonDescriptionsResponseMidocoComplaintReasonDescriptionItem) {
            ...
            if (!$getAvailableComplaintReasonDescriptionsResponseMidocoComplaintReasonDescriptionItem instanceof \Pggns\MidocoApi\Crm\StructType\ComplaintReasonDescrDTO) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\ComplaintReasonDescrDTO[] $midocoComplaintReasonDescription
     * @return \Pggns\MidocoApi\Crm\StructType\GetAvailableComplaintReasonDescriptionsResponse
     */
