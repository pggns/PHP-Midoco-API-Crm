...
class GetExtendedCustomerTravelsRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Crm\StructType\CustomerIdDTO $midocoCustomerId = null, ?int $maxOfRecords = null, array $includedStatus = [], array $excludedStatus = [], ?bool $withoutExtendedInfo = null, ?bool $showFeeDetails = true, ?int $beginIndex = null, ?int $endIndex = null, ?bool $totalNoOfRecordsOnly = null)
    {
        $this
