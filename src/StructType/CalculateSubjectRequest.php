...
class CalculateSubjectRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(array $midocoSubjectElement = [], ?\Pggns\MidocoApi\Crm\StructType\MidocoCrmPrintType $midocoCrmPrintType = null, ?int $orderNo = null, ?int $customerId = null, ?int $documentNo = null, ?string $subjectText = null, ?string $id = null, ?int $documentId = null)
    {
        $this
