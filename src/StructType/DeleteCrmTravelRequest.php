...
class DeleteCrmTravelRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerTravelForArrayConstraintsFromSetMidocoCustomerTravel(array $values = []): string
    {
        ...
        foreach ($values as $deleteCrmTravelRequestMidocoCustomerTravelItem) {
            ...
            if (!$deleteCrmTravelRequestMidocoCustomerTravelItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoCustomerTravelType) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoCustomerTravelType[] $midocoCustomerTravel
     * @return \Pggns\MidocoApi\Crm\StructType\DeleteCrmTravelRequest
     */
