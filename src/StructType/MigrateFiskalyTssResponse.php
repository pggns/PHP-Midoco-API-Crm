...
class MigrateFiskalyTssResponse extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Crm\StructType\Tss_Migration_Summary $migration_Summary = null, array $migration_Log = [], ?\Pggns\MidocoApi\Crm\StructType\Unprocessed_Units $unprocessed_Units = null)
    {
        $this
