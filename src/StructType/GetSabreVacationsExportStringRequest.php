...
class GetSabreVacationsExportStringRequest extends AbstractStructBase
{
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer
     * @return \Pggns\MidocoApi\Crm\StructType\GetSabreVacationsExportStringRequest
     */
    ...
    public static function validateMidocoSelectedCrmPersonTravellerForArrayConstraintsFromSetMidocoSelectedCrmPersonTraveller(array $values = []): string
    {
        ...
        foreach ($values as $getSabreVacationsExportStringRequestMidocoSelectedCrmPersonTravellerItem) {
            ...
            if (!$getSabreVacationsExportStringRequestMidocoSelectedCrmPersonTravellerItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoSelectedCrmPersonTraveller) {
