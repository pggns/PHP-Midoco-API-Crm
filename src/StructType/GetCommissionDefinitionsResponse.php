...
class GetCommissionDefinitionsResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoCommissionDefinition = [];
    /**
     ...
     */
    public function __construct(array $midocoCommissionDefinition = [])
    {
        $this
     ...
     */
    public function setMidocoCommissionDefinition(array $midocoCommissionDefinition = []): self
    {
