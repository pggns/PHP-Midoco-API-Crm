...
class DeleteLetterTemplateRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoLetterTemplateForArrayConstraintsFromSetMidocoLetterTemplate(array $values = []): string
    {
        ...
        foreach ($values as $deleteLetterTemplateRequestMidocoLetterTemplateItem) {
            ...
            if (!$deleteLetterTemplateRequestMidocoLetterTemplateItem instanceof \Pggns\MidocoApi\Crm\StructType\LetterTemplateDTO) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\LetterTemplateDTO[] $midocoLetterTemplate
     * @return \Pggns\MidocoApi\Crm\StructType\DeleteLetterTemplateRequest
     */
