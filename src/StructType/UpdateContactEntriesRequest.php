...
class UpdateContactEntriesRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerIdForArrayConstraintsFromSetMidocoCustomerId(array $values = []): string
    {
        ...
        foreach ($values as $updateContactEntriesRequestMidocoCustomerIdItem) {
            ...
            if (!$updateContactEntriesRequestMidocoCustomerIdItem instanceof \Pggns\MidocoApi\Crm\StructType\CustomerIdDTO) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\CustomerIdDTO[] $midocoCustomerId
     * @return \Pggns\MidocoApi\Crm\StructType\UpdateContactEntriesRequest
     */
