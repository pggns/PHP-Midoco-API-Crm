...
class AssignCriteriaTypesToCategoryRequest extends AbstractStructBase
{
     ...
     */
    protected array $MidocoCriteriaTypeInfo = [];
    /**
     ...
     */
    public function __construct(int $categoryId, array $midocoCriteriaTypeInfo = [])
    {
        $this
     ...
     * @return \Pggns\MidocoApi\Crm\StructType\AssignCriteriaTypesToCategoryRequest
     */
    public function setMidocoCriteriaTypeInfo(array $midocoCriteriaTypeInfo = []): self
    {
