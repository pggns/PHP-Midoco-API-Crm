...
class SaveVirtualCcCardRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard $midocoVirtualCcCard = null, ?bool $isDeactivation = false, ?bool $isTokenization = false)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard $midocoVirtualCcCard
     * @return \Pggns\MidocoApi\Crm\StructType\SaveVirtualCcCardRequest
     */
