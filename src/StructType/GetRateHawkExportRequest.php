...
class GetRateHawkExportRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(string $action, \Pggns\MidocoApi\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer, array $midocoSelectedCrmPersonTraveller = [], ?bool $exportBirthday = null, ?bool $exportAge = null)
    {
        $this
            ->setAction($action)
