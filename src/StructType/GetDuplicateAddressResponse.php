...
class GetDuplicateAddressResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmAddressForArrayConstraintsFromSetMidocoCrmAddress(array $values = []): string
    {
        ...
        foreach ($values as $getDuplicateAddressResponseMidocoCrmAddressItem) {
            ...
            if (!$getDuplicateAddressResponseMidocoCrmAddressItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoCrmAddress) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoCrmAddress[] $midocoCrmAddress
     * @return \Pggns\MidocoApi\Crm\StructType\GetDuplicateAddressResponse
     */
