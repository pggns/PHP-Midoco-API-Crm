...
class GetAllUsersWithAccessToDatastoreOfUnitResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoUserForArrayConstraintsFromSetMidocoUser(array $values = []): string
    {
        ...
        foreach ($values as $getAllUsersWithAccessToDatastoreOfUnitResponseMidocoUserItem) {
            ...
            if (!$getAllUsersWithAccessToDatastoreOfUnitResponseMidocoUserItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoUser) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoUser[] $midocoUser
     * @return \Pggns\MidocoApi\Crm\StructType\GetAllUsersWithAccessToDatastoreOfUnitResponse
     */
