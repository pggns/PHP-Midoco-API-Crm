...
/**
 * This class stands for GetNeoExportStringResponse StructType
 * @subpackage Structs
 */
class GetNeoExportStringResponse extends AbstractStructBase
{
    /**
     * The responseString
     * @var string|null
    ...
    /**
     * Constructor method for GetNeoExportStringResponse
     * @uses GetNeoExportStringResponse::setResponseString()
     ...
     * @param string $responseString
     * @return \Pggns\MidocoApi\Crm\StructType\GetNeoExportStringResponse
     */
