...
class ValidateAddressResponse extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Crm\StructType\MidocoCrmAddress $midocoCrmAddress = null, array $midocoAddressValidate = [], ?string $errorCode = null, ?string $errorText = null, ?string $validationId = null)
    {
        $this
