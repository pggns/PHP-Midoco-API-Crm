...
class GetCustomerMfRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Crm\StructType\CustomerIdDTO $midocoCustomerId = null, array $customerMfRuleAttribute = [], ?string $bean = null, ?string $className = null, ?string $attrName = null, ?string $unitName = null, ?bool $onlyNumeric = null, ?bool $printEnforced = null, ?bool $presetContent = null, ?string $validDate = null)
    {
        $this
