...
class MidocoVirtualCcCard extends VirtualCreditCardDTO
{
     ...
     * @var \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData[]
     */
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData[] $midocoVirtualCcMetaData
     */
    public function __construct(?\Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCardAccount $midocoVirtualCcCardAccount = null, ?array $midocoVirtualCcMetaData = null)
    {
        $this
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCardAccount $midocoVirtualCcCardAccount
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard
     */
     ...
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData[]
     */
    ...
    public static function validateMidocoVirtualCcMetaDataForArrayConstraintFromSetMidocoVirtualCcMetaData(?array $values = []): string
    {
        ...
        foreach ($values as $midocoVirtualCcCardMidocoVirtualCcMetaDataItem) {
            ...
            if (!$midocoVirtualCcCardMidocoVirtualCcMetaDataItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVirtualCcMetaData property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData $item
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard
     */
    public function addToMidocoVirtualCcMetaData(\Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData) {
            throw new InvalidArgumentException(sprintf('The MidocoVirtualCcMetaData property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcMetaData, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
