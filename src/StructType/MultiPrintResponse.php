...
class MultiPrintResponse extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Pggns\MidocoApi\Crm\StructType\MidocoMailMessageType $midocoMailMessage = null, array $historyId = [], array $rtfData = [], array $midocoMailDescription4Inexso = [])
    {
        $this
