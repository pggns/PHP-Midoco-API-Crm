...
class ListPrintSelectsResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintDescriptionForArrayConstraintsFromSetMidocoPrintDescription(array $values = []): string
    {
        ...
        foreach ($values as $listPrintSelectsResponseMidocoPrintDescriptionItem) {
            ...
            if (!$listPrintSelectsResponseMidocoPrintDescriptionItem instanceof \Pggns\MidocoApi\Crm\StructType\PrintDescriptionDTO) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\PrintDescriptionDTO[] $midocoPrintDescription
     * @return \Pggns\MidocoApi\Crm\StructType\ListPrintSelectsResponse
     */
