...
class SaveCustomerMfRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCustomerMfForArrayConstraintFromSetMidocoCustomerMf(?array $values = []): string
    {
        ...
        foreach ($values as $saveCustomerMfRequestMidocoCustomerMfItem) {
            ...
            if (!$saveCustomerMfRequestMidocoCustomerMfItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoCustomerMf) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoCustomerMf[] $midocoCustomerMf
     * @return \Pggns\MidocoApi\Crm\StructType\SaveCustomerMfRequest
     */
