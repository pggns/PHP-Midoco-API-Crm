...
class GetCustomerErrorsResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoCustomerError = [];
    /**
     ...
     */
    public function __construct(array $midocoCustomerError = [])
    {
        $this
     ...
     */
    public function setMidocoCustomerError(array $midocoCustomerError = []): self
    {
