...
class MidocoCustomerMf extends CustomerMfDTO
{
     ...
     * @var \Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO[]
     */
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO[] $midocoCustomerMfAllowedValue
     */
     ...
     * @return \Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO[]
     */
    ...
    public static function validateMidocoCustomerMfAllowedValueForArrayConstraintFromSetMidocoCustomerMfAllowedValue(?array $values = []): string
    {
        ...
        foreach ($values as $midocoCustomerMfMidocoCustomerMfAllowedValueItem) {
            ...
            if (!$midocoCustomerMfMidocoCustomerMfAllowedValueItem instanceof \Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoCustomerMfAllowedValue property can only contain items of type \Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO $item
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoCustomerMf
     */
    public function addToMidocoCustomerMfAllowedValue(\Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO) {
            throw new InvalidArgumentException(sprintf('The MidocoCustomerMfAllowedValue property can only contain items of type \Pggns\MidocoApi\Crm\StructType\CustomerMfAllowedValueDTO, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
