...
class GetPaxconnectUrlStringResponse extends AbstractStructBase
{
    ...
    /**
     * Constructor method for GetPaxconnectUrlStringResponse
     * @uses GetPaxconnectUrlStringResponse::setResponseString()
     ...
     * @param string $responseString
     * @return \Pggns\MidocoApi\Crm\StructType\GetPaxconnectUrlStringResponse
     */
