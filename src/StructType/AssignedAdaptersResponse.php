...
class AssignedAdaptersResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoAdapterForArrayConstraintsFromSetMidocoAdapter(array $values = []): string
    {
        ...
        foreach ($values as $assignedAdaptersResponseMidocoAdapterItem) {
            ...
            if (!$assignedAdaptersResponseMidocoAdapterItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoAdapterType) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoAdapterType[] $midocoAdapter
     * @return \Pggns\MidocoApi\Crm\StructType\AssignedAdaptersResponse
     */
