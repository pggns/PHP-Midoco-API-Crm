...
class GetExternalSystemAttributesResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoExternalSystemAttribute = [];
    /**
     ...
     */
    public function __construct(array $midocoExternalSystemAttribute = [])
    {
        $this
     ...
     */
    public function setMidocoExternalSystemAttribute(array $midocoExternalSystemAttribute = []): self
    {
