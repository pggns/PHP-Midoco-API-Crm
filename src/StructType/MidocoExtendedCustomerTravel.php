...
class MidocoExtendedCustomerTravel extends MidocoCustomerTravelType
{
     ...
     * - minOccurs: 0
     * - ref: MidocoFeeItem
     * @var \Pggns\MidocoApi\Crm\StructType\MidocoFeeItem[]
     */
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoFeeItem[] $midocoFeeItem
    ...
    public static function validateMidocoFeeItemForArrayConstraintsFromSetMidocoFeeItem(array $values = []): string
    {
        ...
        foreach ($values as $midocoExtendedCustomerTravelMidocoFeeItemItem) {
            ...
            if (!$midocoExtendedCustomerTravelMidocoFeeItemItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoFeeItem) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoFeeItem property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoFeeItem, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoFeeItem $item
     * @return \Pggns\MidocoApi\Crm\StructType\MidocoExtendedCustomerTravel
     */
    public function addToMidocoFeeItem(\Pggns\MidocoApi\Crm\StructType\MidocoFeeItem $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Crm\StructType\MidocoFeeItem) {
            throw new InvalidArgumentException(sprintf('The MidocoFeeItem property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoFeeItem, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
