...
class GetCommissionsResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoCommissionExt = [];
    /**
     ...
     */
    public function __construct(array $midocoCommissionExt = [])
    {
        $this
     ...
     */
    public function setMidocoCommissionExt(array $midocoCommissionExt = []): self
    {
