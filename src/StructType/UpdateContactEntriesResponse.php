...
/**
 * This class stands for UpdateContactEntriesResponse StructType
...
class UpdateContactEntriesResponse extends AbstractStructBase
{
    ...
    /**
     * Constructor method for UpdateContactEntriesResponse
     * @uses UpdateContactEntriesResponse::setMidocoCustomerId()
    ...
    public static function validateMidocoCustomerIdForArrayConstraintsFromSetMidocoCustomerId(array $values = []): string
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $updateContactEntriesResponseMidocoCustomerIdItem) {
            // validation for constraint: itemType
            if (!$updateContactEntriesResponseMidocoCustomerIdItem instanceof \Pggns\MidocoApi\Crm\StructType\CustomerIdDTO) {
                $invalidValues[] = is_object($updateContactEntriesResponseMidocoCustomerIdItem) ? get_class($updateContactEntriesResponseMidocoCustomerIdItem) : sprintf('%s(%s)', gettype($updateContactEntriesResponseMidocoCustomerIdItem), var_export($updateContactEntriesResponseMidocoCustomerIdItem, true));
            }
        }
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\CustomerIdDTO[] $midocoCustomerId
     * @return \Pggns\MidocoApi\Crm\StructType\UpdateContactEntriesResponse
     */
