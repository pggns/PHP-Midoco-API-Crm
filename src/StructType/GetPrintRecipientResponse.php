...
class GetPrintRecipientResponse extends AbstractStructBase
{
    ...
    public static function validateMidocoPrintRecipientForArrayConstraintsFromSetMidocoPrintRecipient(array $values = []): string
    {
        ...
        foreach ($values as $getPrintRecipientResponseMidocoPrintRecipientItem) {
            ...
            if (!$getPrintRecipientResponseMidocoPrintRecipientItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoPrintRecipient) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoPrintRecipient[] $midocoPrintRecipient
     * @return \Pggns\MidocoApi\Crm\StructType\GetPrintRecipientResponse
     */
