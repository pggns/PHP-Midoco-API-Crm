...
class GetVirtualCcCardResponse extends AbstractStructBase
{
     ...
     * @var \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard[]
     */
    ...
    public static function validateMidocoVirtualCcCardForArrayConstraintFromSetMidocoVirtualCcCard(?array $values = []): string
    {
        ...
        foreach ($values as $getVirtualCcCardResponseMidocoVirtualCcCardItem) {
            ...
            if (!$getVirtualCcCardResponseMidocoVirtualCcCardItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MidocoVirtualCcCard property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard[] $midocoVirtualCcCard
     * @return \Pggns\MidocoApi\Crm\StructType\GetVirtualCcCardResponse
     */
     ...
     * @throws InvalidArgumentException
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard $item
     * @return \Pggns\MidocoApi\Crm\StructType\GetVirtualCcCardResponse
     */
    public function addToMidocoVirtualCcCard(\Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard) {
            throw new InvalidArgumentException(sprintf('The MidocoVirtualCcCard property can only contain items of type \Pggns\MidocoApi\Crm\StructType\MidocoVirtualCcCard, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
