...
class DeleteOrgunitDatastoresRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoOrgunitDatastoreForArrayConstraintsFromSetMidocoOrgunitDatastore(array $values = []): string
    {
        ...
        foreach ($values as $deleteOrgunitDatastoresRequestMidocoOrgunitDatastoreItem) {
            ...
            if (!$deleteOrgunitDatastoresRequestMidocoOrgunitDatastoreItem instanceof \Pggns\MidocoApi\Crm\StructType\DatastoreAssignDTO) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\DatastoreAssignDTO[] $midocoOrgunitDatastore
     * @return \Pggns\MidocoApi\Crm\StructType\DeleteOrgunitDatastoresRequest
     */
