...
class GetAmadeusExportStringRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $expedientCode = null, ?\Pggns\MidocoApi\Crm\StructType\CrmCustomerDTO $midocoCrmCustomer = null, array $midocoSelectedCrmPersonTraveller = [], array $midocoCustomerTravel = [], ?bool $exportBirthday = null, ?bool $exportAge = null, ?bool $returnJson = false)
    {
        $this
