...
class DeleteCustomerCriteriaRequest extends AbstractStructBase
{
    ...
    public static function validateMidocoCrmCriteriaForArrayConstraintsFromSetMidocoCrmCriteria(array $values = []): string
    {
        ...
        foreach ($values as $deleteCustomerCriteriaRequestMidocoCrmCriteriaItem) {
            ...
            if (!$deleteCustomerCriteriaRequestMidocoCrmCriteriaItem instanceof \Pggns\MidocoApi\Crm\StructType\MidocoCrmCriteria) {
     ...
     * @param \Pggns\MidocoApi\Crm\StructType\MidocoCrmCriteria[] $midocoCrmCriteria
     * @return \Pggns\MidocoApi\Crm\StructType\DeleteCustomerCriteriaRequest
     */
